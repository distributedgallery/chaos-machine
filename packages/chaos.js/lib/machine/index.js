...
var Machine = /** @class */ (function () {
    function Machine(_a) {
        ...
        this.paths = { root: path_1.default.join(os_1.default.homedir(), '.chaos'), tracks: path_1.default.join(os_1.default.homedir(), '.chaos', 'tracks'), log: path_1.default.join(os_1.default.homedir(), '.chaos', 'log') };
        ...
        if (devices) {
            ...
            this.lcd.on('ready', function () {
                ...
                _this.lcd.write('Welcome chaos', function (err) { _this.log.error(err.toString()); });
            });
