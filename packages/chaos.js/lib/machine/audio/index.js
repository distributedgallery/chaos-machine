...
var sound_player_1 = __importDefault(require("sound-player"));
var Audio = /** @class */ (function () {
    function Audio(machine) {
        this.machine = machine;
        this.player = new sound_player_1.default({ player: 'mpg123', filename: '' });
    }
    Audio.prototype.shuffle = function () {
        return __awaiter(this, void 0, void 0, function () {
            var hash;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.machine.contract.shuffle()];
                    case 1:
                        hash = _a.sent();
    ...
    Audio.prototype.play = function (hash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.machine.track.exists(hash)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.machine.track.download(hash)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
