            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.machine.ipfs.files.cat(hash)];
                    case 1:
                        buffer = _a.sent();
